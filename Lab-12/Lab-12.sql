...
INSERT INTO STUDENT_INFO VALUES (101,'RAJU','CE'),
(102,'AMIT','CE'),
(103,'SANJAY','ME'),
(104,'NEHA','EC'),
(105,'MEERA','EE'),
...
INSERT INTO RESULT VALUES (11,8.80,101),
(12,9.20,102),
(13,7.60,103),
(14,8.20,104),
(15,7.00,105),
...
(
    ...
    CITY VARCHAR(100) NOT NULL,FOREIGN KEY (DEPARTMENTID) REFERENCES DEPARTMENT(DEPARTMENTID)
);
...
INSERT INTO PUBLISHER VALUES (1,'RUPA PUBLICATIONS','NEW DELHI'),
(2,'PENGUIN INDIA','GURUGRAM'),
(3,'HARPERCOLLINS INDIA','NOIDA'),
(4,'ALEPH BOOK COMPANY','NEW DELHI');

INSERT INTO AUTHOR VALUES (1,'CHETAN BHAGAT','INDIA'),
...
INSERT INTO BOOK VALUES (101,'FIVE POINT SOMEONE',1,1,250.00,2004),
...
INSERT INTO STADIUM VALUES (101,'Wankhede Stadium',55000,'Mumbai'),
...
INSERT INTO TEAM VALUES (1,'Mumbai Indians','Mark Boucher',12,14,101),
...
INSERT INTO PLAYER VALUES (201,'Virat','Kohli',3,'Batsman',18,25),

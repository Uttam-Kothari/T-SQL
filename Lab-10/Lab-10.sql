...
--4. Display 3rd to 10th character of your name.
	SELECT SUBSTRING('UTTAM KOTHARI',3,7)

--5. Write a query to convert ‘abc123efg’ to ‘abcXYZefg’ & ‘abcabcabc’ to ‘ab5ab5ab5’ using REPLACE.
	SELECT REPLACE ('abc123efg','abc123efg' , 'abcXYZefg'),
	REPLACE ('abcabcabc','abcabcabc' , 'ab5ab5ab5')
	--three argument 1st full string, 2 nd which part you change, 3 rd new data
...
--25. Display FIRSTNAME after replacing vowels with '*'. 
	...
	--SELECT REGEXP_REPLACE(FIRSTNAME, '[AEIOU]', '*') FROM EMPLOYEE;
